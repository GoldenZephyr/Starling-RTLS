...
int main() {
  ...
  while (1) {
    ...
    if (tx_buff.payload[0] == '0') {
      ...
      printf(
        "timestamp_tx_1, timestamp_rx_1, timestamp_tx_2, timestamp_rx_2, timestamp_tx_3, timestamp_rx_3,\
      fp_ampl1_rx_1, fp_ampl1_rx_2, fp_ampl1_rx_3,\
      rxpac_rx_1, rxpacc_rx_2, rxpacc_rx_3,\
      std_noise_1, fp_ampl2_rx_1, fp_ampl3_rx_1, cir_pwr_rx_1,\
      std_noise_2, fp_ampl2_rx_2, fp_ampl3_rx_2, cir_pwr_rx_2,\
      std_noise_3, fp_ampl2_rx_3, fp_ampl3_rx_3, cir_pwr_rx_3");
      while (1) {
         ...
         */
        printf(
          "%llu, %llu, %llu, %llu, %llu, %llu, %d, %d, %d, %d, %u, %u, %u, %u, %u, %u, %u, %u, %u, %u, %u, %u, %u, %u\n",
          (uint64_t) info.timestamp_tx_1,
          (uint64_t) info.timestamp_rx_1,
          (uint64_t) info.timestamp_tx_2,
          (uint64_t) info.timestamp_rx_2,
          (uint64_t) info.timestamp_tx_3,
          (uint64_t) info.timestamp_rx_3,
          info.fp_ampl1_rx_1,
          info.fp_ampl1_rx_2,
          info.fp_ampl1_rx_3,
          info.rxpacc_rx_1,
          info.rxpacc_rx_2,
          info.rxpacc_rx_3,
          info.rx_fqual_1.std_noise,
          info.rx_fqual_1.fp_ampl2,
          info.rx_fqual_1.pp_ampl3,
          info.rx_fqual_1.cir_pwr,
          info.rx_fqual_2.std_noise,
          info.rx_fqual_2.fp_ampl2,
          info.rx_fqual_2.pp_ampl3,
          info.rx_fqual_2.cir_pwr,
          info.rx_fqual_3.std_noise,
          info.rx_fqual_3.fp_ampl2,
          info.rx_fqual_3.pp_ampl3,
          info.rx_fqual_3.cir_pwr);
        fflush(stdout);
